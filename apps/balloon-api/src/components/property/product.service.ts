...
export class ProductService {
	...
	public async getProperties(memberId: ObjectId, input: ProductsInquiry): Promise<Products> {
	...
	public async getAllPropertiesByAdmin(input: AllProductsInquiry): Promise<Products> {
